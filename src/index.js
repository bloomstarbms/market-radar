...
import { pollCadence } from './sources/calendar/cadence-watch.js';
...
async function pollAll() {
  const settled = await Promise.allSettled([pollDex(), pollCex(), pollFunding(), pollCascade(), pollAnnouncements(), pollMacro(), pollEvents(), pollUnlocks(), pollUpbit(), pollCadence()]);
